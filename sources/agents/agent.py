...
class Agent():
    ...
    def __init__(self, name: str,
        ...
        self.last_answer = ""
        self.last_reasoning = ""
        self.status_message = "Belum dimulai"
        self.stop = False
    ...
    def request_stop(self) -> None:
        ...
        """
        self.stop = True
        self.status_message = "Dihentikan"
    ...
    async def llm_request(self) -> Tuple[str, str]:
        ...
        """
        self.status_message = "Sedang berpikir..."
    ...
    async def wait_message(self, speech_module):
        if speech_module is None:
            return
        messages = ["Mohon bersabar, saya sedang mengerjakannya.",
                    "Memproses... Saya sarankan minum kopi selagi saya bekerja.",
                    "Tunggu sebentar, saya sedang memproses data.",
                    "Sedang dikerjakan, biarkan saya berpikir."]
        loop = asyncio.get_event_loop()
